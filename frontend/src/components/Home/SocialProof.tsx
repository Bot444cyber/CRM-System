        ...
        <section className="relative w-full bg-black py-20 sm:py-28 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="mt-16 sm:mt-24 relative">
                    <div
                        className="relative rounded-[2rem] border border-white/5 bg-[#0a0a0d] p-8 sm:p-12 md:p-16 overflow-hidden flex flex-col justify-between"
                        style={{ boxShadow: '0 0 0 1px rgba(255,255,255,0.03) inset, 0 32px 80px rgba(0,0,0,0.6)', minHeight: '400px' }}
                    >
                        {/* Subtle left glow */}
                        <div className="absolute top-1/2 -translate-y-1/2 -left-32 w-96 h-96 rounded-full bg-white/5 blur-3xl pointer-events-none" />
                        ...
                        {/* Card Footer: Dots + Counter */}
                        <div className="flex items-center justify-between w-full relative z-10 pt-6 border-t border-white/5">
                            {/* Dot nav (Screenshot style: small circles, active is a wider pill) */}
                            <div className="flex items-center gap-2">
                                {testimonials.map((_, i) => (
                                    <button
                                        key={i}
                                        onClick={() => setActive(i)}
                                        className={`h-1.5 rounded-full transition-all duration-400 cursor-pointer ${active === i ? 'w-5 sm:w-8 bg-white/70' : 'w-1.5 bg-white/10 hover:bg-white/30'}`}
                                    />
                                ))}
                            </div>

                            {/* Counter */}
                            <span className="text-white/20 text-[10px] sm:text-xs font-medium tracking-widest">
                ...
                <motion.div
                    ...
                    className="mt-12 sm:mt-16 grid grid-cols-2 lg:grid-cols-4 gap-px bg-white/6 rounded-2xl overflow-hidden border border-white/6"
                >
                    {[
                        ...
                        <div key={s.label} className="bg-[#0c0c10] px-6 py-6 sm:py-8 text-center">
